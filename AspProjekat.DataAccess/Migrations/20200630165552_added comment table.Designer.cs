...
namespace AspProjekat.DataAccess.Migrations
{
    ...
    [Migration("20200630165552_added comment table")]
            ...
            modelBuilder.Entity("AspProjekat.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 30, 18, 55, 52, 360, DateTimeKind.Local).AddTicks(6362),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Rock"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 30, 18, 55, 52, 363, DateTimeKind.Local).AddTicks(1364),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Country"
                        },
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 30, 18, 55, 52, 363, DateTimeKind.Local).AddTicks(1405),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Jazz"
                        },
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2020, 6, 30, 18, 55, 52, 363, DateTimeKind.Local).AddTicks(1410),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Children"
                        },
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2020, 6, 30, 18, 55, 52, 363, DateTimeKind.Local).AddTicks(1415),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Blues"
                        });
