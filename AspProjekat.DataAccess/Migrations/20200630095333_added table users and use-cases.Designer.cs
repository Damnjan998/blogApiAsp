...
namespace AspProjekat.DataAccess.Migrations
{
    ...
    [Migration("20200630095333_added table users and use-cases")]
    partial class addedtableusersandusecases
    {
            ...
            modelBuilder.Entity("AspProjekat.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2020, 6, 30, 11, 53, 32, 662, DateTimeKind.Local).AddTicks(8870),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Rock"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2020, 6, 30, 11, 53, 32, 665, DateTimeKind.Local).AddTicks(3533),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Country"
                        },
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2020, 6, 30, 11, 53, 32, 665, DateTimeKind.Local).AddTicks(3569),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Jazz"
                        },
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2020, 6, 30, 11, 53, 32, 665, DateTimeKind.Local).AddTicks(3574),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Children"
                        },
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2020, 6, 30, 11, 53, 32, 665, DateTimeKind.Local).AddTicks(3579),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Blues"
                        });
